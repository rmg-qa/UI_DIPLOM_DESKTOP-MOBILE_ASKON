...
##### В конфигурациях джобы Jenkins реализованы параметры запуска автотестов с возможностью выбора: только дестоп, только мобильные, или запуск всех автотестов сразу.
