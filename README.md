...
##### После выполнения тестов в Telegram bot приходит сообщение с графиком и информацией о тестовом прогоне. Реализовано оповещение, только когда тесты падают (условия оповещения настраиваются в jenkins).
